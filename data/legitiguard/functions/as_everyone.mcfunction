...
# Creative Mode
    ...
    execute if score .permanentCreative lg.Values matches 0 unless entity @s[predicate=legitiguard:staff_member] if entity @s[gamemode=creative] run function legitiguard:creative_mode/timed_mode
